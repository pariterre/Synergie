...
from .StopingPage import StopingPage
...
class App:
    ...
    def __init__(self):
        ...
        while True:
            try: 
                self._database_manager = DatabaseManager(certificate_path="s2m-skating-firebase-adminsdk-3ofmb-8552d58146.json")
                break
        ...
        self._connexion_page = ConnectionPage(self._root_window, self._database_manager)
    ...
    def _show_launch_main_page(self):
        ...
        threading.Thread(target=self._initialize_dot_manager, args=([initialialize_event]), daemon=True).start()
